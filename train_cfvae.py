...
if __name__ == '__main__':
  ...
  checkpoints_path = os.path.join(args.project_dir, 'checkpoints', args.experiment_name, args.outcome, args.senitive_variable, args.trial_id)
  performance_path = os.path.join(args.project_dir, 'performance', args.experiment_name, args.outcome, args.senitive_variable, args.trial_id)
